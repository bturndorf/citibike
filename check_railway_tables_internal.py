#!/usr/bin/env python3
"""
Script to check Railway PostgreSQL database using internal connection string
"""

import sys
from sqlalchemy import create_engine, text

# Try the internal Railway connection string (from railway variables output)
DATABASE_URL_INTERNAL = "postgresql://postgres:gToMomZwJyYGcOzZGSRGGkLLkWSQXqzi@postgres.railway.internal:5432/railway"

def check_railway_tables_internal():
    """Connect to Railway PostgreSQL using internal connection"""
    
    print("🔍 Connecting to Railway PostgreSQL database (internal)...")
    ...
    try:
        ...
        print(f"❌ Error connecting to Railway database (internal): {e}")
        return False
    
    return True

if __name__ == "__main__":
    print("🚂 Railway PostgreSQL Database Table Check (Internal)")
    print("=" * 60)
    success = check_railway_tables_internal()
